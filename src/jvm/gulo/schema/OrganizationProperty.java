...
public class OrganizationProperty implements org.apache.thrift.TBase<OrganizationProperty, OrganizationProperty._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new OrganizationPropertyStandardSchemeFactory());
    schemes.put(TupleScheme.class, new OrganizationPropertyTupleSchemeFactory());
  }
   ...
   */
  public OrganizationProperty(OrganizationProperty other) {
    if (other.isSetId()) {
  ...
  public OrganizationProperty deepCopy() {
  ...
  public OrganizationProperty setId(OrganizationID id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof OrganizationProperty)
      return this.equals((OrganizationProperty)that);
    return false;
  }

  public boolean equals(OrganizationProperty that) {
    if (that == null)
      return false;
  ...
  public int compareTo(OrganizationProperty other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    OrganizationProperty typedOther = (OrganizationProperty)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("OrganizationProperty(");
    boolean first = true;
  ...
  private static class OrganizationPropertyStandardSchemeFactory implements SchemeFactory {
    public OrganizationPropertyStandardScheme getScheme() {
      return new OrganizationPropertyStandardScheme();
    }
  }

  private static class OrganizationPropertyStandardScheme extends StandardScheme<OrganizationProperty> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, OrganizationProperty struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, OrganizationProperty struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class OrganizationPropertyTupleSchemeFactory implements SchemeFactory {
    public OrganizationPropertyTupleScheme getScheme() {
      return new OrganizationPropertyTupleScheme();
    }
  }

  private static class OrganizationPropertyTupleScheme extends TupleScheme<OrganizationProperty> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, OrganizationProperty struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, OrganizationProperty struct) throws org.apache.thrift.TException {
